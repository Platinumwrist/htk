...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HTK features */
        {"htk", "masternode", &masternode, true, true, false},
        {"htk", "masternodelist", &masternodelist, true, true, false},
        {"htk", "mnbudget", &mnbudget, true, true, false},
        {"htk", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"htk", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"htk", "mnsync", &mnsync, true, true, false},
        {"htk", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use htkd, or the -server option to htk-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> htk-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58200/\n";
}
