                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HTK-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HTK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and htk: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HTK Core"), this);
    aboutAction->setStatusTip(tr("Show information about HTK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HTK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HTK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HTK addresses"));
    ...
    openAction->setStatusTip(tr("Open a HTK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HTK Core help message to get a list with possible HTK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HTK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HTK network", "", count));
}
...
{
    QString strTitle = tr("HTK Core"); // default title
