...
public:
    ...
    /// Get 1000HTK output and keys which can be used for the Masternode
    ...
    bool CreateCoinStake(const CKeyStore& keystore, CBlock *pblock, unsigned int nBits, int64_t nSearchInterval, CMutableTransaction& txNew, unsigned int& nTxNewTime);
    bool MultiSend();
