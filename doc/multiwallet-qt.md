...
In order to support loading of multiple wallets in htk-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is htk.cpp.
...
Changes to htk.cpp
----------------------
htk.cpp is the entry point into htk-qt, and as such, will require some minor modifications to provide hooks for
